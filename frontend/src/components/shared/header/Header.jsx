...
import logo_societe_icon from '../../../assets/logo_company_icon.png'
...
const Header = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await axios.get(`${import.meta.env.VITE_API_URL}/globalhome?id=${id}`);
                    ...
                    <div className="d-flex align-items-center">
                        {window.innerWidth >= 1000 ? 
                            <div style={{display: 'flex', flexDirection: 'row', marginRight: '100px'}}>
                                <div>
                                    {userData.path === null || !userData.path  ?
                                        <img src={logo_societe_icon} alt="Logo entreprise"  style={{height: '50px', borderRadius: '5px'}}/>
                                        :
                                        <img src={`${import.meta.env.VITE_API_URL}` + userData.path} alt="Logo entreprise"  style={{height: '50px', borderRadius: '5px'}}/>
                                    }
                                </div>
                                <div style={{display: 'flex', alignItems: 'center', marginLeft: 20, color: 'black', fontSize: 17}}>
