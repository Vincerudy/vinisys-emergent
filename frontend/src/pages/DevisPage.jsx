...
const handleModalOk = async () => {
  ...
  const calculateTotals = () => {
    ...
    // Logique de taxe secondaire selon le contexte
    let taxeSecondaire = null;
    let tauxTPS = 0;
    
    if (useTaxeSecondaire) {
      if (isEditingFacture && editingTaxeSecondaire) {
        // Mode modification : utiliser le taux du devis original
        taxeSecondaire = {
          label: `TPS`,
          value: editingTaxeSecondaire.value
        };
        tauxTPS = parseFloat(editingTaxeSecondaire.value);
      } else {
        // Mode création : utiliser la taxe secondaire actuellement paramétrée
...
/>
        ...
        <div className="containerModalMail">
          ...
          <Form form={form} layout="vertical" initialValues={{ date: dayjs() }}>
            ...
            {/* Taxe secondaire - Affichage conditionnel selon le contexte */}
            {tvas.find(tva => tva.taxe_secondaire === 'OUI') && (
              ...
              >
                ...
                >
                  ...
                  <Radio value="OUI">
                    {isEditingFacture && editingTaxeSecondaire ? (
                      // Mode modification : afficher le taux du devis original
                      `OUI - TPS ${editingTaxeSecondaire.value}%`
                    ) : (
                      // Mode création : afficher le taux actuellement paramétré
